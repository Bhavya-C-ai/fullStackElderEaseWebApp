			...
			<section>
				...
				>
					...
					<div className="swiper testimonial-01 mb-20 pb-22.5">
						...
						>
							<SwiperSlide>
								<div class="flex items-center justify-center h-full  w-full pt-12 p-4">
									<div
										data-aos-delay="150"
										class="rounded-xxl bg-white p-6 text-center shadow-xl"
									>
							...
							<SwiperSlide>
								<div class="flex items-center justify-center  h-full  w-full pt-12 p-4">
									<div class="rounded-xxl bg-white p-6 text-center shadow-xl">
										...
										<p class="px-4 text-gray-500 text-xl">
											{clicks["Virabhadrasana II"]}
										</p>
										<h1 class="text-darken mb-3 text-xl font-medium lg:px-14 " style={{ whiteSpace: 'nowrap' }}>
											Warrior 2
										</h1>
									</div>
								</div>
